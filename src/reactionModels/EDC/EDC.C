...
Foam::reactionModels::EDC<ReactionThermo>::EDC
(
...
template<class ReactionThermo>
void Foam::reactionModels::EDC<ReactionThermo>::correct()
{
...
Foam::reactionModels::EDC<ReactionThermo>::R(volScalarField& Y) const
{
...
Foam::reactionModels::EDC<ReactionThermo>::Qdot() const
{
...
template<class ReactionThermo>
bool Foam::reactionModels::EDC<ReactionThermo>::read()
{
