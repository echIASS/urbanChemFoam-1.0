...
Foam::reactionModels::PaSR<ReactionThermo>::PaSR
(
...
:
    laminar<ReactionThermo>(modelType, thermo, turb, reactionProperties),
...
template<class ReactionThermo>
void Foam::reactionModels::PaSR<ReactionThermo>::correct()
{
...
Foam::reactionModels::PaSR<ReactionThermo>::R(volScalarField& Y) const
{
...
Foam::reactionModels::PaSR<ReactionThermo>::Qdot() const
{
...
template<class ReactionThermo>
bool Foam::reactionModels::PaSR<ReactionThermo>::read()
{
